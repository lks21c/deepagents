...
```mermaid
graph TD
    subgraph MemoryFlow["Memory System Flow"]
        subgraph Sources["Memory Sources"]
            S1["~/.deepagents/AGENTS.md<br/>&#40;글로벌 사용자 설정&#41;"]
            S2["./project/AGENTS.md<br/>&#40;프로젝트별 설정&#41;"]
            S3["./team/AGENTS.md<br/>&#40;팀별 설정&#41;"]
            S1 --> S2 --> S3
        end
        MW["MemoryMiddleware<br/>1. before_agent: 소스에서 메모리 로드<br/>2. wrap_model_call: 시스템 프롬프트에 주입"]
        SP["System Prompt<br/>&lt;agent_memory&gt;<br/>글로벌 메모리 내용 + 프로젝트 메모리 내용<br/>&lt;/agent_memory&gt;<br/>&lt;memory_guidelines&gt;<br/>학습 및 업데이트 지침<br/>&lt;/memory_guidelines&gt;"]
