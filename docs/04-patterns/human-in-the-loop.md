...
```mermaid
graph TD
    subgraph HITL["Human-in-the-Loop Flow"]
        AG["Agent"]
        TC["도구 호출: edit_file&#40;'/src/main.py', ...&#41;"]
        HM["HumanInTheLoopMiddleware<br/>interrupt_on: {edit_file: True}<br/>→ 인터럽트 발생!"]
        PA["⏸️ 실행 일시 중지<br/>사용자에게 표시:<br/>edit_file&#40;'/src/main.py', ...&#41;<br/>승인하시겠습니까? [Y/n]"]
        AP["승인 ✅<br/>실행 계속"]
        RJ["거부 ❌<br/>피드백 제공"]
